...
import TakeActionMethod from './updateperception';

const AppViewAllAppointment = () => {
    ...
    return (
        <div>
            {patientDetails && (
             ...
             {openDialog && <TakeActionMethod handleClose={handleClose} id={location.state.id}/>}
        </div>
    );
};

export default AppViewAllAppointment;
