...
const CompledtedAppointment=()=>{
    ...
    const getPublishedPosts = () => {
        setLoader(true);
        let getProps = {
            url: userModuleURL.doctorcompletedappointment,
            successCallback,
            failureCallback,
        }
            ...
            <Table>
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell sx={{bgcolor: "primary.main", color:"white"}}>Perception</TableCell>
                        <TableCell sx={{bgcolor: "primary.main", color:"white"}}>Recommendedtest</TableCell>
                ...
                <TableBody>
                    {responseData && responseData.map((appointment) => (
                        <TableRow key={appointment.id}>
                            ...
                            <TableCell>{appointment.recommendedtest}</TableCell>
...
export default CompledtedAppointment;